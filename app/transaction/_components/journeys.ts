...
export const journeys: Record<string, JourneyStep[]> = {
  ...
  "TT-0002": [
    ...
    },
    {
      step: 5,
      title: "Departed Site",
      description: "Vehicle departed hospital with remains after autopsy release",
  ...
  "TT-0003": [
    ...
    },
    {
      step: 3,
      title: "Departed Chapel",
      description: "Vehicle left chapel with casket heading to Quezon City Residence",
    ...
    },
    {
      ...
      description: "Driver arrived at Quezon City Residence for outside viewing",
    ...
    },
    {
      ...
      description: "Outside viewing completed; remains loaded back onto vehicle",
  ...
  "TT-0005": [
    ...
    },
    {
      step: 3,
      title: "Departed Chapel",
      description: "Vehicle left chapel with casket heading to Manila North Cemetery",
  ...
  MS: [
    {
      ...
      description: "Memorial service booked; retrieval request submitted by family",
    ...
    },
    {
      ...
      description: "Chapel personnel contacted family and confirmed the retrieval request",
    ...
    },
    {
      ...
      description: "Embalming ticket created with family preferences and instructions",
    ...
    },
    {
      step: 6,
      title: "Contracting",
      description: "Service info finalized; memorial service contract details saved",
    ...
    },
    {
      ...
      description: "Remaining charges reviewed and payment settled (2 days before interment)",
      dateTime: "",
      status: "Pending",
    },
    {
      step: 9,
      title: "Interment",
      description: "On the day of interment; final rites and burial or cremation",
      dateTime: "",
      status: "Pending",
    },
    {
  ...
  "EMB-20260622-001": [
    ...
    },
    {
      ...
      description: "Embalming ticket being prepared with instructions and preferences",
      dateTime: "",
      status: "Current",
    },
    {
  ...
  "EMB-20260622-002": [
    ...
    },
    {
      ...
      description: "Embalming ticket assigned with instructions and preferences",
    ...
    },
    {
      step: 4,
      title: "Embalming In Progress",
      description: "Procedure underway — natural look with light cosmetics only",
  ...
  "EMB-20260622-003": [
    ...
    },
    {
      step: 2,
      title: "Ticket Created",
      description: "Embalming ticket assigned — hair dye: dark brown per family",
    ...
    },
    {
      step: 5,
      title: "Embalming Completed",
      description: "Normal outcome; Standard Set B chemicals used; hair dye applied",
  ...
  "EMB-20260622-004": [
    ...
    },
    {
      step: 5,
      title: "Embalming Completed",
      description: "Normal outcome; hand position adjusted due to autopsy incision",
  ...
  "EMB-20260622-005": [
    ...
    },
    {
      step: 5,
      title: "Embalming Completed",
      description: "Completed with complications — minor discoloration on left hand",
      dateTime: "2026-06-21 02:00 PM",
      status: "Done",
    },
    {
      step: 6,
      title: "Supervisor Verification",
      description: "Failed — visible discoloration on left hand noted by Supervisor M. Lim",
    ...
    },
    {
      ...
      description: "Sent back for cosmetic correction on left hand discoloration",
      dateTime: "",
      status: "Current",
    },
    {
...
export const journeyMeta: Record<string, JourneyMeta> = {
  ...
  "TT-0001": { name: "Juan Dela Cruz", transactionType: "Trip Ticket — Retrieval" },
  "TT-0002": { name: "Maria Santos", transactionType: "Trip Ticket — Autopsy" },
  "TT-0003": { name: "Pedro Ramirez", transactionType: "Trip Ticket — Outside Viewing" },
  "TT-0004": { name: "Ana Lopez", transactionType: "Trip Ticket — Chapel Viewing" },
  "TT-0005": { name: "Roberto Lim", transactionType: "Trip Ticket — Interment" },
  "TT-0006": { name: "Carlos Bautista", transactionType: "Trip Ticket — Wake Visit" },
  "TT-0007": { name: "Luis Garcia", transactionType: "Trip Ticket — Inter-Chapel Transfer" },
  "TT-0008": { name: "N/A", transactionType: "Trip Ticket — Equipment Delivery" },
