...
const SOCIAL_PROVIDERS = [
  {
    ...
    providerLogo: "/images/osp-chakra-reusable-components/icons8-google-48.png",
  ...
  },
  {
    ...
    providerLogo: "/images/osp-chakra-reusable-components/icons8-meta-48.png",
...
export function LoginPage({ onLogin }: LoginPageProps = {}) {
  ...
  // Desktop skips the mobile "Quick Sign In" welcome screen and defaults straight to the password form.
  const effectiveStage = isDesktop && stage === "welcome" ? "password" : stage;
  const isDesktopDefaultView = isDesktop && stage === "welcome";
  ...
  // A successful login navigates to the account page (and notifies any parent
  // via the optional onLogin callback).
        ...
        {SOCIAL_PROVIDERS.map((p) => (
          <motion.button
            ...
            style={{
              ...
              opacity: socialLoading && socialLoading !== p.id ? 0.45 : 1,
              transition:
          ...
          >
            ...
            >
              {avatarErrors[p.id] ? (
                ...
                // Plain <img> (not next/image): these are arbitrary/expiring
                // social-CDN URLs, so we skip remote-host config and fall back
                // to initials via onError.
            ...
            <VStack flex={1} gap={0} alignItems="flex-start" minW={0} w="full">
              <Text
                fontSize="sm"
                fontWeight="semibold"
                color="gray.800"
  ...
  return (
    // The login route renders inside the app shell (navbar / footer / bottom
    // nav / chatbot FAB), so it covers them with a full-screen overlay —
    // zIndex sits above the highest shell element (the FAB at 1200).
    <Box
      position="fixed"
      inset={0}
      zIndex={2000}
    ...
    >
      ...
      <Flex minH="100%" bg="white" overflow="hidden">
        ...
        >
          ...
          <motion.div {...fadeUp(0)}>
            <VStack position="relative" zIndex={10} mt={0} mb={5} gap={1}>
              <Flex
                w="6rem"
                h="6rem"
                rounded="2xl"
              ...
              >
                <Image
                  ...
                  width={68}
                  height={68}
                  // width/height auto preserves the aspect ratio when global
                  // img CSS resizes one axis (silences a next/image warning)
                  style={{
                    objectFit: "contain",
                    width: "auto",
                    height: "auto",
              ...
              <AnimatePresence mode="wait">
                {effectiveStage === "welcome" ? (
                  ...
                  >
                    ...
                    <Box mb={8} display={{ base: "block", md: "none" }}>
                      <Heading
                        as="h2"
                        fontSize="2xl"
                        fontWeight="bold"
