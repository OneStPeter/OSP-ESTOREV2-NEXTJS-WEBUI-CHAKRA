...
import { MdOutlineMessage, MdMessage, MdOutlineApps, MdApps } from "react-icons/md";
import {
  RiHome4Line,
  RiHome4Fill,
  RiInformationFill,
...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    activeIcon: MdApps,
    subItems: [
      { label: "Pay My Plan", href: "/account/pay-my-plan" },
      { label: "Return of Premium", href: "/account/return-of-premium" },
      { label: "File A Claim", href: "/claims" },
      { label: "Reinstatement", href: "/account/reinstatement" },
    ],
  },
  {
    label: "News & Blog",
